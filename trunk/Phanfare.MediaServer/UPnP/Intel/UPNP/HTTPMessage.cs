namespace Intel.UPNP
{
    ...
    public sealed class HTTPMessage : ICloneable
    {
		...
		public string UserAgent
		{
			get
			{
				return this.GetTag( "User-Agent" );
			}
			set
			{
				this.AddTag( "User-Agent", value );
			}
		}

		public string AVClientInfo
		{
			get
			{
				return this.GetTag( "X-AV-CLIENT-INFO" );
			}
		}
		...
		public string Host
		{
			get
			{
				return this.GetTag( "Host" );
			}
			set
			{
				this.AddTag( "Host", value );
			}
		}
